...
const copy: Record<Locale, Copy> = {
  nl: {
    ...
    blocks: [
      ...
      { title: "Met wie delen we je gegevens?", paras: ["Met niemand, tenzij wettelijk verplicht. Geen marketing, geen verkoop.", "Voor hosting werken we met Vercel (EU regio) en Supabase (EU regio). Voor e-mail eventueel Resend. Allemaal partijen met een eigen GDPR-conformiteit."] },
  ...
  fr: {
    ...
    blocks: [
      ...
      { title: "Avec qui partageons-nous vos données ?", paras: ["Avec personne, sauf obligation légale. Pas de marketing, pas de vente.", "Pour l'hébergement nous utilisons Vercel (région EU) et Supabase (région EU). Pour l'e-mail éventuellement Resend. Tous conformes au RGPD."] },
  ...
  en: {
    ...
    blocks: [
      ...
      { title: "Who do we share your data with?", paras: ["With no one, unless legally required. No marketing, no selling.", "For hosting we use Vercel (EU region) and Supabase (EU region). For email possibly Resend. All GDPR-compliant."] },
