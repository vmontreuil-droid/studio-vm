...
const copy: Record<Locale, Copy> = {
  nl: {
    ...
    services: [
      { title: "Website", intro: "Een snelle, mooie website die echt voor je zaak werkt. Mobile-first, dark mode, SEO-klaar.", details: ["Custom design op jouw merk", "Snelle laadtijden (PageSpeed 95+)", "Native dark mode", "Open Graph + structured data", "Geen onderhoudsdrama achteraf"], pricing: "vanaf €2 500", pricingHref: "/pricing#starter" },
      { title: "Webshop", intro: "Een eigen verkoopkanaal, geen Etsy/Shopify-marge. Mollie of Stripe, eigen klantportaal, alles van jou.", details: ["Mollie of Stripe checkout", "Producten, varianten, voorraad", "Kortingscodes + gift cards", "Klantportaal met bestellingen", "Bestellingen-admin met facturen"], pricing: "vanaf €7 500", pricingHref: "/pricing#webshop" },
  ...
  en: {
    ...
    services: [
      { title: "Website", intro: "A fast, polished website that truly works for your business. Mobile-first, dark mode, SEO-ready.", details: ["Custom design on your brand", "Fast load times (PageSpeed 95+)", "Native dark mode", "Open Graph + structured data", "No maintenance drama afterwards"], pricing: "from €2,500", pricingHref: "/pricing#starter" },
      { title: "Webshop", intro: "Your own sales channel, no Etsy/Shopify margin. Mollie or Stripe, own customer portal, all yours.", details: ["Mollie or Stripe checkout", "Products, variants, stock", "Discount codes + gift cards", "Customer portal with orders", "Orders admin with invoices"], pricing: "from €7,500", pricingHref: "/pricing#webshop" },
