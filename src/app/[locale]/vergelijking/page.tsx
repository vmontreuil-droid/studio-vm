...
const copy: Record<Locale, Copy> = {
  nl: {
    ...
    rows: [
      ...
      { feature: "Snel live (dagen, geen maanden)", values: ["meh", "yes", "yes", "no"] },
  ...
  fr: {
    ...
    rows: [
      ...
      { feature: "Rapide en ligne (jours, pas mois)", values: ["meh", "yes", "yes", "no"] },
  ...
  en: {
    ...
    rows: [
      ...
      { feature: "Fast live (days, not months)", values: ["meh", "yes", "yes", "no"] },
