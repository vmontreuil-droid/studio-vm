...
const copy: Record<Locale, Copy> = {
  nl: {
    ...
    phases: [
      ...
      { n: "03", title: "Design", what: "Geen statische mockups die er nooit zo uitzien. Een eerste klikbare versie op een staging-omgeving, iteratief verfijnd met jouw input.", you: "Klik erdoor, geef feedback. Je hoeft geen designer te zijn — 'dit voelt niet goed' is bruikbare input.", deliver: "Een werkende, klikbare versie op je eigen staging-URL.", duration: "~2 weken", risk: "Smaakverschil is normaal. We werken in rondes; het pakket bepaalt hoeveel rondes inbegrepen zijn." },
      { n: "04", title: "Development", what: "De echte bouw: site + admin + integraties. Tussentijdse demo's zodat je niet vier weken in het ongewisse zit.", you: "Lever content aan (teksten, foto's) en test tussentijds op staging. Hoe sneller jouw input, hoe sneller de oplevering.", deliver: "Een complete, geteste site op staging — door jou zelf te testen.", duration: "2–6 weken naargelang scope", risk: "Vertraging door ontbrekende content schuift de deadline evenredig — daarom plannen we content-aanlevering expliciet in." },
  ...
  en: {
    ...
    phases: [
      ...
      { n: "03", title: "Design", what: "No static mockups that never look like that. A first clickable version on a staging environment, iteratively refined with your input.", you: "Click through, give feedback. You don't need to be a designer — 'this feels off' is usable input.", deliver: "A working, clickable version on your own staging URL.", duration: "~2 weeks", risk: "Taste differences are normal. We work in rounds; the package defines how many are included." },
      { n: "04", title: "Development", what: "The real build: site + admin + integrations. Interim demos so you're not in the dark for four weeks.", you: "Provide content (text, photos) and test on staging. The faster your input, the faster delivery.", deliver: "A complete, tested site on staging — for you to test yourself.", duration: "2–6 weeks depending on scope", risk: "Delay due to missing content shifts the deadline proportionally — which is why we plan content delivery explicitly." },
