...
const copy: Record<Locale, Copy> = {
  nl: {
    ...
    sections: [
      ...
      { title: "Looptijd & opzegging abonnement", body: "Het onderhoudsabonnement heeft een minimumlooptijd van 1 jaar. Opzegging gebeurt schriftelijk en minstens 1 maand vóór het einde van de lopende jaarperiode. Gebeurt dit niet, dan wordt het abonnement stilzwijgend verlengd voor telkens één jaar. Reeds gefactureerde periodes worden niet terugbetaald." },
  ...
  fr: {
    ...
    sections: [
      ...
      { title: "Durée & résiliation abonnement", body: "L'abonnement de maintenance a une durée minimale d'1 an. La résiliation se fait par écrit, au moins 1 mois avant la fin de la période annuelle en cours. À défaut, l'abonnement est reconduit tacitement pour un an à chaque fois. Les périodes déjà facturées ne sont pas remboursées." },
  ...
  en: {
    ...
    sections: [
      ...
      { title: "Mandatory maintenance subscription", body: "For every project, one maintenance subscription (Care, Plus, Scale or Partner) is mandatory from the first month. It covers hosting, security, updates and support. The client freely chooses the level and can upgrade at any time via the client portal. The subscription has a minimum term of 1 year and, unless cancelled in writing at least 1 month before the end of the current yearly term, renews tacitly for one year each time." },
      ...
      { title: "Subscription term & cancellation", body: "The maintenance subscription has a minimum term of 1 year. Cancellation must be made in writing at least 1 month before the end of the current yearly term. Otherwise the subscription renews tacitly for one year each time. Already invoiced periods are not refunded." },
