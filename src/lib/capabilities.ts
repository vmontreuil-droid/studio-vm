...
const data: Record<Slug, Record<Locale, Content>> = {
  websites: {
    nl: {
      ...
      faq: [
        ...
        { q: "Wat kost dit?", a: "Vanaf €950 voor een Starter (tot 5 pagina's). Bewust betaalbaar gehouden — zie de pricing-pagina voor de details." },
    ...
    fr: {
      ...
      faq: [
        ...
        { q: "Combien ça coûte ?", a: "Dès €950 pour un Starter (jusqu'à 5 pages). Volontairement abordable — voir la page tarifs pour le détail." },
    ...
    en: {
      ...
      faq: [
        ...
        { q: "What does this cost?", a: "From €950 for a Starter (up to 5 pages). Deliberately affordable — see the pricing page for details." },
  ...
  webshops: {
    nl: {
      ...
      faq: [
        ...
        { q: "Wat kost een webshop?", a: "Vanaf €3 900 inclusief tot 100 producten. Zie pricing voor de Webshop-formule." },
      ],
    ...
    fr: {
      ...
      faq: [
        ...
        { q: "Combien coûte une boutique ?", a: "Dès €3 900 avec jusqu'à 100 produits. Voir tarifs pour la formule Boutique." },
      ],
    ...
    en: {
      ...
      faq: [
        ...
        { q: "What does a webshop cost?", a: "From €3,900 including up to 100 products. See pricing for the Webshop plan." },
      ],
  ...
  hosting: {
    nl: {
      ...
      faq: [
        { q: "Moet ik een abonnement nemen?", a: "Niet verplicht. Zonder abonnement staat je site op de free tier; support reken ik dan per uur (€95/u). Een onderhoudsabonnement (Basis/Care/Plus/Scale/Partner) is doorgaans goedkoper én geruststellender." },
        ...
        { q: "Wat kost dit?", a: "Van Basis €19/m tot Partner €799/m — Care €49/m, Plus €149/m, Scale €399/m ertussen. Zie pricing voor wat erin zit." },
      ],
    ...
    fr: {
      ...
      faq: [
        { q: "Dois-je prendre un abonnement ?", a: "Pas obligatoire. Sans abonnement, votre site reste sur le free tier ; le support est alors à l'heure (€95/h). Un abonnement d'entretien (Basis/Care/Plus/Scale/Partner) est généralement moins cher et plus rassurant." },
        ...
        { q: "Combien ça coûte ?", a: "De Basis €19/m à Partner €799/m — Care €49/m, Plus €149/m, Scale €399/m entre les deux. Voir tarifs pour le contenu." },
      ],
    ...
    en: {
      ...
      faq: [
        { q: "Do I have to take a subscription?", a: "Not required. Without one, your site sits on the free tier; support is then hourly (€95/h). A maintenance subscription (Basis/Care/Plus/Scale/Partner) is usually cheaper and more reassuring." },
        ...
        { q: "What does this cost?", a: "From Basis €19/m to Partner €799/m — Care €49/m, Plus €149/m, Scale €399/m in between. See pricing for what's included." },
      ],
