...
const data: Record<Locale, Bundle> = {
  nl: {
    ...
    addons: [
      ...
      { name: "Contactformulier", price: "€ 125", desc: "Contactformulier met spamfilter en mailopvolging — inbegrepen in elk pakket." },
  ...
  fr: {
    ...
    addons: [
      ...
      { name: "Formulaire de contact", price: "€ 125", desc: "Formulaire anti-spam avec suivi mail — inclus dans chaque forfait." },
  ...
  en: {
    ...
    addons: [
      ...
      { name: "Contact form", price: "€ 125", desc: "Anti-spam contact form with mail follow-up — included in every package." },
