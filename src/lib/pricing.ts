...
const data: Record<Locale, Bundle> = {
  nl: {
    oneShot: [
      { slug: "starter", name: "Starter", tagline: "Voor wie net begint", price: "€ 2 500", priceNote: "eenmalig, excl. btw", features: ["Tot 5 pagina's", "Eigen design op jouw merk", "Mobile + dark mode", "Contactformulier", "SEO + sitemap + Open Graph", "1 ronde aanpassingen"], ctaLabel: "Start gesprek", ctaHref: "/#contact" },
      { slug: "pro", name: "Pro", tagline: "Meest gekozen", price: "€ 4 500", priceNote: "eenmalig, excl. btw", features: ["Tot 15 pagina's", "Tweetalig (NL/FR of NL/EN)", "Eigen admin om content te wijzigen", "Newsletter signup", "Structured data + analytics", "2 rondes aanpassingen"], highlighted: true, ctaLabel: "Start gesprek", ctaHref: "/#contact" },
      { slug: "webshop", name: "Webshop", tagline: "Voor verkoop online", price: "vanaf € 7 500", priceNote: "eenmalig, excl. btw", features: ["Alles van Pro", "Volledige webshop met Mollie of Stripe", "Voorraad, kortingscodes, gift cards", "Klantportaal voor bestellingen", "Bestellingen-admin met facturen", "Tot 100 producten inbegrepen"], ctaLabel: "Bespreek shop", ctaHref: "/#contact" },
  ...
  fr: {
    oneShot: [
      { slug: "starter", name: "Starter", tagline: "Pour bien démarrer", price: "€ 2 500", priceNote: "unique, HTVA", features: ["Jusqu'à 5 pages", "Design propre à votre marque", "Mobile + dark mode", "Formulaire de contact", "SEO + sitemap + Open Graph", "1 tour de modifications"], ctaLabel: "Démarrer", ctaHref: "/#contact" },
      { slug: "pro", name: "Pro", tagline: "Le plus choisi", price: "€ 4 500", priceNote: "unique, HTVA", features: ["Jusqu'à 15 pages", "Bilingue (NL/FR ou NL/EN)", "Admin propre pour modifier le contenu", "Inscription newsletter", "Données structurées + analytics", "2 tours de modifications"], highlighted: true, ctaLabel: "Démarrer", ctaHref: "/#contact" },
      { slug: "webshop", name: "Boutique", tagline: "Pour vendre en ligne", price: "dès € 7 500", priceNote: "unique, HTVA", features: ["Tout de Pro", "Boutique complète avec Mollie ou Stripe", "Stock, codes promo, cartes-cadeaux", "Espace client pour les commandes", "Admin commandes avec factures", "Jusqu'à 100 produits inclus"], ctaLabel: "Discuter boutique", ctaHref: "/#contact" },
  ...
  en: {
    oneShot: [
      { slug: "starter", name: "Starter", tagline: "For getting started", price: "€ 2,500", priceNote: "one-off, excl. VAT", features: ["Up to 5 pages", "Custom design on your brand", "Mobile + dark mode", "Contact form", "SEO + sitemap + Open Graph", "1 round of revisions"], ctaLabel: "Start a chat", ctaHref: "/#contact" },
      { slug: "pro", name: "Pro", tagline: "Most chosen", price: "€ 4,500", priceNote: "one-off, excl. VAT", features: ["Up to 15 pages", "Bilingual (NL/FR or NL/EN)", "Own admin to edit content", "Newsletter signup", "Structured data + analytics", "2 rounds of revisions"], highlighted: true, ctaLabel: "Start a chat", ctaHref: "/#contact" },
      { slug: "webshop", name: "Webshop", tagline: "For selling online", price: "from € 7,500", priceNote: "one-off, excl. VAT", features: ["Everything in Pro", "Full webshop with Mollie or Stripe", "Stock, discount codes, gift cards", "Customer portal for orders", "Orders admin with invoices", "Up to 100 products included"], ctaLabel: "Discuss a shop", ctaHref: "/#contact" },
