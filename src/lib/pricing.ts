...
const data: Record<Locale, Bundle> = {
  nl: {
    oneShot: [
      { slug: "onepager", name: "One-pager", tagline: "Klein beginnen", price: "€ 750", priceNote: "eenmalig, excl. btw", features: ["1 sterke pagina (alles op één scroll)", "Maatwerk-design in jouw stijl", "Mobile + dark mode inbegrepen", "Contactformulier inbegrepen", "Teksten / copywriting inbegrepen", "Cookiebanner & GDPR inbegrepen", "1 extra taal inbegrepen", "SEO + sitemap + Open Graph inbegrepen", "Extra ronde aanpassingen inbegrepen", "Geen eigen admin / CMS — optioneel (+ € 450)", "Care-abonnement inbegrepen"], ctaLabel: "Start gesprek", ctaHref: "/#contact" },
      { slug: "starter", name: "Starter", tagline: "Voor wie net begint", price: "€ 1 250", priceNote: "eenmalig, excl. btw", features: ["Tot 5 pagina's", "Maatwerk-design in jouw stijl", "Eigen admin / CMS inbegrepen", "Mobile + dark mode inbegrepen", "Contactformulier + teksten inbegrepen", "2 extra talen inbegrepen", "Cookiebanner & GDPR inbegrepen", "Blog / nieuws-CMS inbegrepen", "SEO-behoud bij migratie inbegrepen", "Extra ronde aanpassingen inbegrepen", "Care-abonnement inbegrepen"], ctaLabel: "Start gesprek", ctaHref: "/#contact" },
      { slug: "pro", name: "Pro", tagline: "Meest gekozen", price: "€ 1 900", priceNote: "eenmalig, excl. btw", features: ["Tot 15 pagina's", "Alles van Starter — meertalig inbegrepen", "SEO + sitemap + Open Graph inbegrepen", "Newsletter signup inbegrepen", "Reservatie / afspraken inbegrepen", "Ledenzone inbegrepen", "Formulieren + opvolging inbegrepen", "2 rondes aanpassingen", "Plus-abonnement inbegrepen"], highlighted: true, ctaLabel: "Start gesprek", ctaHref: "/#contact" },
  ...
  fr: {
    oneShot: [
      { slug: "onepager", name: "One-pager", tagline: "Commencer petit", price: "€ 750", priceNote: "unique, HTVA", features: ["1 page forte (tout en un scroll)", "Design sur mesure à votre image", "Mobile + dark mode inclus", "Formulaire de contact inclus", "Textes / rédaction inclus", "Bannière cookies & RGPD incluse", "1 langue supplémentaire incluse", "SEO + sitemap + Open Graph inclus", "Tour de modifications supplémentaire inclus", "Pas d'admin / CMS — en option (+ € 450)", "Abonnement Care inclus"], ctaLabel: "Démarrer", ctaHref: "/#contact" },
      { slug: "starter", name: "Starter", tagline: "Pour bien démarrer", price: "€ 1 250", priceNote: "unique, HTVA", features: ["Jusqu'à 5 pages", "Design sur mesure à votre image", "Admin / CMS inclus", "Mobile + dark mode inclus", "Formulaire de contact + textes inclus", "2 langues supplémentaires incluses", "Bannière cookies & RGPD incluse", "CMS blog / actus inclus", "Préservation SEO (migration) incluse", "Tour de modifications supplémentaire inclus", "Abonnement Care inclus"], ctaLabel: "Démarrer", ctaHref: "/#contact" },
      { slug: "pro", name: "Pro", tagline: "Le plus choisi", price: "€ 1 900", priceNote: "unique, HTVA", features: ["Jusqu'à 15 pages", "Tout de Starter — multilingue inclus", "SEO + sitemap + Open Graph inclus", "Inscription newsletter incluse", "Réservation / rendez-vous inclus", "Espace membres inclus", "Formulaires + suivi inclus", "2 tours de modifications", "Abonnement Plus inclus"], highlighted: true, ctaLabel: "Démarrer", ctaHref: "/#contact" },
  ...
  en: {
    oneShot: [
      { slug: "onepager", name: "One-pager", tagline: "Start small", price: "€ 750", priceNote: "one-off, excl. VAT", features: ["1 strong page (all on one scroll)", "Bespoke design in your style", "Mobile + dark mode included", "Contact form included", "Copywriting / texts included", "Cookie & GDPR banner included", "1 extra language included", "SEO + sitemap + Open Graph included", "Extra revision round included", "No own admin / CMS — optional (+ € 450)", "Care subscription included"], ctaLabel: "Start a chat", ctaHref: "/#contact" },
      { slug: "starter", name: "Starter", tagline: "For getting started", price: "€ 1,250", priceNote: "one-off, excl. VAT", features: ["Up to 5 pages", "Bespoke design in your style", "Own admin / CMS included", "Mobile + dark mode included", "Contact form + texts included", "2 extra languages included", "Cookie & GDPR banner included", "Blog / news CMS included", "SEO migration safeguard included", "Extra revision round included", "Care subscription included"], ctaLabel: "Start a chat", ctaHref: "/#contact" },
      { slug: "pro", name: "Pro", tagline: "Most chosen", price: "€ 1,900", priceNote: "one-off, excl. VAT", features: ["Up to 15 pages", "Everything in Starter — multilingual included", "SEO + sitemap + Open Graph included", "Newsletter signup included", "Booking / appointments included", "Members area included", "Forms + follow-up included", "2 rounds of revisions", "Plus subscription included"], highlighted: true, ctaLabel: "Start a chat", ctaHref: "/#contact" },
