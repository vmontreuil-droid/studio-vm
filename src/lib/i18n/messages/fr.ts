...
const fr: Messages = {
  ...
  mogelijkheden: {
    ...
    intro:
      "Sous le capot, c'est toujours la même stack — Next.js, Supabase, Tailwind. Les modules dont vous avez besoin dépendent de votre activité. Voici un aperçu.",
  },
  contact: {
    eyebrow: "Contact",
  ...
  newsletter: {
    eyebrow: "Newsletter",
    intro: "Une fois par mois, un court e-mail sur ce que j'ai construit et appris.",
